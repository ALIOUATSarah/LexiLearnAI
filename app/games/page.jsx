...
import { GameDragDrop } from "@/components/games/drag-drop-game"
  ...
  const games = [
    {
      id: "memory",
      title: "Memory Match",
      description: "Match pairs of cards to test your memory skills while learning physics concepts.",
      component: GameMemory,
    },
    {
      id: "dragdrop",
      title: "Drag & Drop Challenge",
      description: "Drag items to their correct categories to reinforce your understanding of scientific principles.",
      component: GameDragDrop,
    },
    {
      id: "quiz",
      title: "Speed Quiz",
      description: "Answer questions quickly to earn more points in this fast-paced learning game.",
      component: GameQuiz,
    },
  ]
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-8">
            ...
            <p className="text-lg text-gray-700">
              Have fun while reinforcing what you've learned with these interactive games!
            </p>
          </div>
          ...
          {!activeGame ? (
            ...
            <div>
              <div className="mb-4 flex justify-between items-center">
                ...
                <Button variant="outline" className="border-blue-300 text-blue-600" onClick={() => setActiveGame(null)}>
                  Back to Games
                </Button>
              </div>
